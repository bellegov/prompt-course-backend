...
import com.promptcourse.progressservice.service.CompletedTestService; // <-- Импорт
...
public class InternalAttemptController {
    ...
    private final CompletedTestService completedTestService; // <-- Добавляем зависимость
